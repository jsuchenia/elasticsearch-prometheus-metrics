...
## Installation
To install this plugin just add it into your version of ES. Example for *0.10.1* version for *ES 6.4.0*:
```
bin/elasticsearch-plugin install https://github.com/jsuchenia/elasticsearch-prometheus-metrics/releases/download/0.10.1/prometheus-metrics-0.10.1-6.4.0.zip
```
